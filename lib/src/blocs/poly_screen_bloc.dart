...
class PolyScreenBloc extends BlocBase {
  static final PolyRepository _repository=PolyRepository.getRepo();
  PublishSubject<String> _query;

  init() {
    print("Poly Bloc Init");
    _query = PublishSubject<String>();
  }

  Observable<List<Asset>> get photosList => _query.stream
